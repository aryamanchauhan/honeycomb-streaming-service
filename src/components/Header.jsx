...
import ytlogo from "/HONEYCOMB_arya.svg";
...
const Header = () => {
  ...
  return (
    <div className="sticky top-0 z-20 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-white dark:bg-gray-900">
      {loading && <Loader />}
      ...
      <div className="flex h-5 items-center">
        ...
        <Link to="/" className="flex h-5 items-center mt-4">
          <img
            ...
            alt="Youtube"
          />
          <div className="hidden dark:hidden md:block text-yellow-500 dark:text-yellow-300 text-lg cursor-pointer flex items-center px-3 mb-[4px] rounded-lg hover:dark:bg-white/[0.15] hover:dark:bg-white[0.15]">HoneyComb</div>
          {/* <img className="h-full md:hidden mr-6" src={ytlogo} alt="Youtube" /> */}
        </Link>
      </div>
      <div className="group flex items-center my-1 mr-7">
        <div className="flex h-8 md:h-10 md:ml-10 md:pl-5 border-2 border-yellow-300 group-focus-within:border-2 md:group-focus-within:ml-5 md:group-focus-within:pl-0">
        ...
        <button
          className="w-[40px] md:w-[60px] h-8 md:h-10 flex items-center justify-center border-2 border-l-0 border-yellow-300 bg-white/[0.1] dark:bg-black/[0.1]"
