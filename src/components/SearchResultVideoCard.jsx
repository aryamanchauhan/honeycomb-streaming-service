    ...
    <Link to={`/video/${video?.videoId}`}>
      <div className="flex flex-col md:flex-row mb-8 md:mb-3 dark:lg:hover:bg-white/[0.1]  lg:hover:bg-black/[0.1] md:p-4">
        ...
        <div className="flex  flex-col ml-4 md:ml-6 mt-4 md:mt-0 overflow-hidden">
          ...
          <span className="empty:hidden text-sm line-clamp-1 md:line-clamp-2 text-black/[0.7] dark:text-white md:pr-24 md:my-4">
          ...
          <div className="flex items-center">
            ...
            <div className="flex flex-col">
              <span className="text-sm font-semibold mt-2 text-black/[0.7] dark:text-white flex items-center">
                {video?.author?.title}
                {/* {video?.author?.badges[0]?.type === "VERIFIED_CHANNEL" && (
                  <BsFillCheckCircleFill className="text-black/[0.7] dark:text-white/[0.5] text-[12px] lg:text-[10px] xl:text-[12px] ml-1" />
                )} */}
              </span>
              <div className="flex text-sm font-semibold text-black/[0.7] dark:text-white truncate overflow-hidden">
