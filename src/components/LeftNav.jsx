...
function LeftNav() {
  ...
  return (
    <div
      className={`md:block w-[240px] overflow-y-auto h-full py-4 bg-white dark:bg-gray-900 absolute md:relative z-10 hide translate-x-[-240px] md:translate-x-0 transition-all ${
